...
class Parser {
  /**
   * Replace scope variables with table references.
   * @param {String} sql
  ...
  /**
   * Check if the string is valid SQL operator.
   * @param {String} str
   */
  static isOperator(str) {
    return SQL_OPERATORS.has(str.toUpperCase());
  }

  /**
   * Extract all variables with two or more parts separated by `.` from the query.
   * @param {String} cond
   */
  static vars(cond) {
